...
function authenticateUser(username, password) {
    ...
    let result = username===validUsername && password===validPassword ? "Login sucessful." : "Login failed. Please check your username and password."
    return result
   }
   ...
   console.log(authenticateUser(username3,password3))